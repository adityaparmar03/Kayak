...
KafkaRPC.prototype.makeRequest = function(req_topic_name, res_topic_name, content, callback){
    ...
    self.setupResponseQueue(self.producer,function(){
        ...
        var payloads = [
            { topic: req_topic_name, messages: JSON.stringify({
                correlationId:correlationId,
                replyTo:res_topic_name,
