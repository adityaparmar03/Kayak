...
class BarChart extends React.Component {
    ...
    constructor(){
        ...
        this.state = {
            chartType:"BarChart",
            options : {
                title: "Top 5 most booked flights",
                hAxis: {title: 'Number of bookings', minValue: 0, maxValue: 15},
                vAxis: {title: 'Flights', minValue: 0, maxValue: 15},
                bar: {
                    groupWidth: "50%"
                },
                legend: {
    ...
    renderChart(){
        var payload={name:"Top5FlightChart",type:"Top5FlightChart",index:7,query:"top5FlightChart"};
