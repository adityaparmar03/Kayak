...
class BarChart extends React.Component {
    ...
    constructor(){
        ...
        this.state = {
            chartType:"BarChart",
            options : {
                title: "Top 5 most booked hotels",
                hAxis: {title: 'Number of bookings', minValue: 0, maxValue: 15},
                vAxis: {title: 'Hotels', minValue: 0, maxValue: 15},
                bar: {
                    groupWidth: "50%"
                },
                legend: {
    ...
    renderChart(){
        var payload={name:"Top5HotelChart",type:"Top5HotelChart",index:8,query:"top5HotelChart"};
